...
const CastSection = () => {
  return (
    <div className="z-30 relative container mx-auto w-full p-4 md:px-8 bg-white">
      <div className="absolute top-[-60px] left-0 w-full h-20 bg-gradient-to-t from-white/95 to-transparent backdrop-blur-[12px] z-40 pointer-events-none"></div>
      <div className="absolute bottom-[-60px] left-0 w-full h-20 bg-gradient-to-b from-white/95 to-transparent backdrop-blur-[12px] z-40 pointer-events-none"></div>

      <div
        className="relative flex flex-col items-center w-full min-h-[120vh]     "
        data-aos="fade-up"
      >
        <div className={`relative  w-full `}>
          <div
            className={`top-[0vh] capitalize absolute z-10 flex flex-col items-center w-full text-black text-center ${playfairDisplay.className}`}
          >
